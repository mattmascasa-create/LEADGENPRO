...
async def subscribe_to_push(
    ...
    # Also update notification preferences to indicate push is enabled
    await db.notification_preferences.update_one(
        {"user_id": current_user.id},
...
async def send_push_to_user(user_id: str, title: str, message: str, data: dict = None):
    ...
    <body style="margin: 0; padding: 0; background-color: #f5f5f5; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); border-radius: 12px 12px 0 0; padding: 32px; text-align: center;">
                <h1 style="color: white; margin: 0; font-size: 24px;">☀️ Good Morning, {user_name}!</h1>
...
@api_router.post("/notifications/send-digest")
async def send_daily_digest(
    current_user: User = Depends(get_current_user)
):
    """Send daily digest email to the current user (can be triggered manually or by cron)"""
    if not RESEND_API_KEY:
...
@api_router.post("/notifications/send-digest-all")
...
@api_router.get("/notifications/digest-preview")
