          ...
          <div className="p-4 text-center relative">
            ...
            {callStatus === 'calling_agent' && (
              <div className="py-4">
                ...
                <p className="text-blue-400 font-semibold">Calling Your Phone...</p>
                <p className="text-slate-500 text-sm mt-1">{statusMessage}</p>
                <p className="text-slate-400 text-xs mt-2 bg-slate-800/50 py-1.5 px-3 rounded-full inline-block">Answer and press 1</p>
              </div>
            )}
            ...
            {callStatus === 'connecting' && (
              <div className="py-4">
                ...
                <p className="text-yellow-400 font-semibold">Connecting to Lead...</p>
                <p className="text-slate-400 text-sm">{formatPhoneDisplay(phoneNumber)}</p>
                <div className="flex items-center justify-center gap-2 mt-3 text-white text-2xl font-mono">
            ...
            {callStatus === 'connected' && (
              <div className="py-4">
                ...
                <div className="flex items-center justify-center text-white text-4xl font-mono mb-2">
                  {formatDuration(callDuration)}
                </div>
                <p className="text-slate-400 text-sm">{formatPhoneDisplay(phoneNumber)}</p>
                {isRecording && (
            ...
            {callStatus === 'ended' && !showOutcomeModal && (
              <div className="py-4">
                ...
                <p className="text-slate-300 font-semibold">Call Ended</p>
            ...
            {callStatus === 'failed' && (
              <div className="py-4">
                ...
                <p className="text-red-400 font-semibold">Call Failed</p>
